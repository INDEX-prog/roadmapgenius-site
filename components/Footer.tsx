        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
          ...
          <div className="col-span-2">
            <Link href="/" className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-xl font-bold">RoadmapGenius</span>
            </Link>
            <p className="text-gray-400 mb-6 max-w-xs">
              Créez des roadmaps produit époustouflantes qui inspirent et
              alignent vos équipes.
            </p>
            ...
            <div className="flex space-x-4">
              {[
                ...
                (social: { name: string; icon: React.ReactElement }) => (
                  <a
                    key={social.name}
                    href="#"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="md:flex md:items-center md:justify-between">
            <div className="text-gray-400 text-sm">
              © {currentYear} RoadmapGenius. Tous droits réservés.
            </div>
